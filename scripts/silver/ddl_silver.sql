...
Scripts Purpose:
	This Script create tables in the silver schema with some additional meatadata columns in the tables.
  Metadata :  
           1) dwh_create_date  DATE DEFAULT GETDATE()   --> for every table
*/
